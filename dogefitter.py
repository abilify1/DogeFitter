...
class main:
 ...
 def banner():
  main.jalan(f"""{w.k}   ___                _____ __  __         
  / _ \___  ___ ____ / __(_) /_/ /____ ____
 / // / _ \/ _ `/ -_) _// / __/ __/ -_) __/
/____/\___/\_, /\__/_/ /_/\__/\__/\__/_/   
{w.k}          /___/                            """)
 def subbanner():
  main.jalan(f"""{w.i}[{w.h}-{w.i}] {w.b}Author {w.i}: {w.m}abilseno11
{w.i}[{w.h}-{w.i}] {w.b}Nama SC {w.i}: {w.m}Script nuyul web dogefitter.pw
{w.i}[{w.h}-{w.i}] {w.b}Github {w.i}: {w.m}https://github.com/AbilSeno
 ...
 def start():
     ...
     main.tik()
     while True:
      mul = r.get('https://dogefitter.pw/dashboard',headers=hd,cookies=coki).text
